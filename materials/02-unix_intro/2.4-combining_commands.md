...
:::::{.callout-important icon=false}
## ***Exercise 2.4.2:*** Piping Commands Together
...
:::::{.callout-important icon=false}
## ***Exercise 2.4.3:*** An example pipeline: Checking Files
...
:::::{.callout-important icon=false}
## ***Exercise 2.4.4:*** Pipe Reading Comprehension
...
:::::{.callout-important icon=false}
## ***Exercise 2.4.5:*** Pipe Construction
...
:::::{.callout-important icon=false}
## ***Exercise 2.4.7:*** Filtering by patterns
...
:::::{.callout-important icon=false}
## ***Exercise 2.4.8:*** Pipe Comprehension
