...
:::::{.callout-important icon=false}
## ***Exercise 2.9.1:*** List Unique Species
...
:::::{.callout-important icon=false}
## ***Exercise 2.9.2:*** Why Record Commands in the History Before Running Them?
...
:::::{.callout-important icon=false}
## ***Exercise 2.9.3:*** Variables in Shell Scripts
...
:::::{.callout-important icon=false}
## ***Exercise 2.9.4:*** Find the Longest File With a Given Extension
...
:::::{.callout-important icon=false}
## ***Exercise 2.9.5:*** Script Reading Comprehension
...
:::::{.callout-important icon=false}
## ***Exercise 2.9.6:*** Debugging Scripts
