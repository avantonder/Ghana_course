...
<!--
FIXME: Only include this if it works with the systme being used for the course:::{.callout-note}
...
## Running bash scripts with arguments
...
Suppose we have just run a series of commands that did something useful --- for example, that created a graph we'd like to use in a paper.
...
## Indicating program to execute script
...
<!--FIXME: ediyt the diagram below to fit the purpose.The nano and bash commands in the figure should be changed-->

## Summary: Key features of a script
