...
:::::{.callout-important icon=false}
## ***Exercise:*** Create a conda environment
...
2. If we search for this software on the _Anaconda_ website, we will find that it is available via the "_bioconda_" channel: https://anaconda.org/bioconda/bowtie2 
